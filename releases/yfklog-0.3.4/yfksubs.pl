...
# Upgrade from Version 0.2.5 to 0.3.4. Nothing really to do.
if ($oldversion < 34) {
	$dbh->do("update YFKconfig set `Value` = '0.3.4' where
	`Name` = 'version';") or die "Unable to set version in table YFKconfig!";
	printw "Updated DB to 0.3.4.\n";
}
